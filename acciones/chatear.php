...
<nav class="navbar navbar-expand-lg navbar-dark bg-black fixed-top">
    ...
    <div class="messages">
        ...
        <div class="message message-user2">
            <strong>Usuario2:</strong> ¡Hola! Estoy bien, gracias.
        </div>
        <div class="message message-user1">
            <strong>Usuario1:</strong> ¿Qué has estado haciendo?
        </div>
        <div class="message message-user2">
            <strong>Usuario2:</strong> Trabajando y disfrutando el tiempo libre.
        </div>
        <!-- Aquí se pueden agregar más mensajes -->
    </div>

    <div class="chat-input">
        <input type="text" class="input-message" placeholder="Escribe un mensaje..." aria-label="Escribe un mensaje...">
